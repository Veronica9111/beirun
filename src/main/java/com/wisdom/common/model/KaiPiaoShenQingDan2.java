...
public class KaiPiaoShenQingDan2 implements Serializable {
   ...
   public KaiPiaoShenQingDan2() {
       super();
   }
   
   public KaiPiaoShenQingDan2(Integer id,String fengongsimingcheng,String xiangmubu,String xiangmumingcheng,String hetongzongjine,Timestamp shenqingriqi,Double kaijufapiao,Double shouqikuanxiang,String wangongjindu,Double qita,String kaipiaoneirong,String tianbiaoren,String tianbiaorendianhua,Timestamp tianbiaoriqi,Integer xiangmutaizhang_id){
   	super();
		this.id = id;
